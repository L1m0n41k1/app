    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.emptyState}>
        ...
        <Text style={styles.emptyStateText}>
          Создайте шаблоны сообщений для автоматической рассылки
        </Text>
        <TouchableOpacity style={styles.addTemplateButton}>
          <Text style={styles.addTemplateButtonText}>Создать шаблон</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
